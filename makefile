...
MODULE_STM32F2_LOW_LEVEL_BY_ST_S_FILE				+= $(STARTUPE_S_NAME)
...
MODULE_STM32F2_LOW_LEVEL_BY_ST_OBJ_FILE				+= $(addprefix build/obj/, $(MODULE_STM32F2_LOW_LEVEL_BY_ST_S_FILE))
...
MODULE_STM32F2_LOW_LEVEL_BY_ST_OBJ_FILE				:= $(patsubst %.s, %.o, $(MODULE_STM32F2_LOW_LEVEL_BY_ST_OBJ_FILE))
